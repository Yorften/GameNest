...
export const selectRepositoryLoading = (state: RootState) => state.repositories.loading;
export const selectRepositoryError = (state: RootState) => state.repositories.error;
