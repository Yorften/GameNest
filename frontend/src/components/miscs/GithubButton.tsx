  ...
  return (
    <>
      <button type="button"
        ...
        className={`flex items-center bg-gray-600 hover:bg-gray-700 text-white rounded-lg shadow-md px-6 py-2 text-sm font-medium focus:outline-none active:brightness-150 transition-all duration-150 md:order-last ${className}`}
      >
        ...
        <span className='text-white'>Install Github Application</span>
      </button>
    </>
  );
}